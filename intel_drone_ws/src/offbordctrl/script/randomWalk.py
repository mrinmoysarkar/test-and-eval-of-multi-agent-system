...
if __name__ == '__main__':
    ...
    rospy.init_node('drone_randomwalk_intel1', anonymous=True)
    ...
    rospy.Subscriber("/vicon/jackal2/jackal2", TransformStamped, setPoint_cb)
    rospy.Subscriber("/intel1/mavros/battery", BatteryState, batterystate_cb)
