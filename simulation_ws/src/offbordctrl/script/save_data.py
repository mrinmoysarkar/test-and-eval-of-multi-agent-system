...
class datalogger():
    ...
    def loop(self):
        ...
        fileName = "~/ros-intel-uav-rpeo/simulation_ws/src/offbordctrl/flightData/flight_path_data_uav" + str(self.uavno) + "_" + datetime.now().strftime("%Y%m%d-%H%M%S") + "_labeled.csv"
