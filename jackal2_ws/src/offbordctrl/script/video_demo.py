...
def loop():
    ...
    rotateZero(pub)
    rospy.sleep(1)
    goto_2dLocation(pub,1.8,5.91)
    rospy.sleep(1)
    goto_2dLocation(pub,1.8,8.9)
    rospy.sleep(1)
    goto_2dLocation(pub,0,8.9)
    rospy.sleep(1)
    goto_2dLocation(pub,0,5.91)
    rospy.sleep(1)
    rotateZero(pub)
    rospy.sleep(1)
    goto_2dLocation(pub,0.7,5.91)
    rospy.sleep(1)
