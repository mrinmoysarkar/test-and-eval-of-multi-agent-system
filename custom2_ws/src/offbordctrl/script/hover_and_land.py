...
if __name__ == '__main__':
    ...
    setvelPub = rospy.Publisher('/custom2/mavros/setpoint_velocity/cmd_vel_unstamped',Twist,queue_size=100)
    setvel = Twist()
    setvel.linear.x=0
    setvel.linear.y=0
    setvel.linear.z=-0.2
    ...
    if set_mode('OFFBOARD', 5) and set_arm(True, 5):
        ...
        #     rate.sleep()
        #     if current_alt < 0.6 and breaking_flag:
        #         print('breaking2')
        #         break
